...
AbdelRMBUI.Button("F5_mainMenu", "Informations", function()
    fetchPlayerInfo()
    updatePlayerInfoMenu()
    AbdelRMBUI.OpenMenu("F5", "playerInfo")
end)

AbdelRMBUI.Button("F5_mainMenu", "Portefeuille", function()
    fetchPlayerInfo()
    updatePlayerMoneyMenu()
    AbdelRMBUI.OpenMenu("F5", "playerMoney")
end)

AbdelRMBUI.Button("F5_mainMenu", "Factures", function()
...
function updatePlayerInfoMenu()
    ...
    AbdelRMBUI.Button("F5_playerInfo", "ID: " .. playerId)
    AbdelRMBUI.Button("F5_playerInfo", "Job: " .. job)
    AbdelRMBUI.Button("F5_playerInfo", "Retour au Menu Principal", function()
...
function updatePlayerMoneyMenu()
    ...
    AbdelRMBUI.Button("F5_playerMoney", "Espèces: $" .. cash)
    AbdelRMBUI.Button("F5_playerMoney", "Banque: $" .. bank)
    AbdelRMBUI.Button("F5_playerMoney", "Argent sale: $" .. dirtyMoney)
    AbdelRMBUI.Button("F5_playerMoney", "Retour au Menu Principal", function()
        AbdelRMBUI.OpenMenu("F5", "mainMenu")
    end)
end
...
function updatePlayerBillsMenu()
    ...
    if #bills > 0 then
        for _, bill in ipairs(bills) do
            ...
            AbdelRMBUI.Button("F5_playerBills", label, function()
        ...
        AbdelRMBUI.Button("F5_playerBills", "Aucune facture disponible.")
    end

    AbdelRMBUI.Button("F5_playerBills", "Retour au Menu Principal", function()
        AbdelRMBUI.OpenMenu("F5", "mainMenu")
    end)
end
